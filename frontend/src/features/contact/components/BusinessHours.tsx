    ...
    <section className="py-12 bg-gray-50/50">
      <Container>
        <div className="max-w-5xl mx-auto bg-purple-800 rounded-none p-6 md:p-6 lg:p-6 text-center text-white shadow-2xl relative overflow-hidden">
          ...
          <h2 className="text-2xl md:text-3xl font-bold mb-8 relative z-10 tracking-tight">Business Hours</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-6 relative z-10">
            <div className="bg-white/10 backdrop-blur-md rounded-none p-6 border border-white/20 shadow-xl">
              <p className="text-purple-200 text-sm md:text-base font-medium mb-3">Monday - Friday</p>
              <p className="text-xl md:text-2xl font-bold">09:00 - 20:00</p>
            </div>
            
            <div className="bg-white/10 backdrop-blur-md rounded-none p-6 border border-white/20 shadow-xl">
              <p className="text-purple-200 text-sm md:text-base font-medium mb-3">Saturday</p>
              <p className="text-xl md:text-2xl font-bold">09:00 - 18:00</p>
            </div>

            <div className="bg-white/10 backdrop-blur-md rounded-none p-6 border border-white/20 shadow-xl">
              <p className="text-purple-200 text-sm md:text-base font-medium mb-3">Sunday</p>
              <p className="text-xl md:text-2xl font-bold text-pink-300">Closed</p>
            </div>
          </div>
        </div>
      </Container>
