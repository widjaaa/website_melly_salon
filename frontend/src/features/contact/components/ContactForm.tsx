    ...
    <section className="py-20 bg-white">
      <Container>
        <div className="max-w-4xl mx-auto">
          <Card className="bg-white border-transparent shadow-2xl shadow-purple-900/5 rounded-[3rem] overflow-hidden">
            <CardContent className="p-8 md:p-12 lg:p-16">
              ...
              {isSuccess ? (
                <div className="bg-green-50 border border-green-200 text-green-800 rounded-3xl p-10 text-center animate-in fade-in zoom-in duration-500">
