...
export function ContactCard({ icon, title, details }: ContactCardProps) {
  return (
    <Card className="h-full bg-white hover:-translate-y-2 transition-transform duration-300 border-none shadow-sm hover:shadow-xl rounded-none overflow-hidden group text-center border border-gray-50">
