        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link to="/booking" className="w-full sm:w-auto" tabIndex={-1}>
              <Button size="lg" className="w-full sm:w-auto px-12 py-4 shadow-xl shadow-purple-900/20 text-lg">
                Book Appointment
              </Button>
            </Link>
            <Link to="/contact" className="w-full sm:w-auto" tabIndex={-1}>
              <Button size="lg" variant="outline" className="w-full sm:w-auto px-12 py-4 bg-white text-lg">
                Contact Us
              </Button>
            </Link>
          </div>
