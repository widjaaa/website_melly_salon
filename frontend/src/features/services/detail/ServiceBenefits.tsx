...
export function ServiceBenefits() {
  return (
    <section className="py-20 lg:py-32 bg-gray-50/50 border-y border-gray-100">
      <Container>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mt-16">
          {BENEFITS.map((benefit, idx) => (
            <div 
              key={idx} 
              className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-50 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center text-center group"
            >
