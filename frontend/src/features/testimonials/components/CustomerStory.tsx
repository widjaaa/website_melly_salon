...
export function CustomerStory() {
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <Container>
        <div className="bg-gradient-to-br from-purple-800 to-purple-900 rounded-[3rem] p-8 md:p-16 lg:p-20 shadow-2xl relative overflow-hidden max-w-6xl mx-auto">
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
            {/* Customer Image */}
            <div className="relative">
              <div className="absolute inset-0 bg-pink-500 rounded-[2rem] transform -rotate-3 scale-105 opacity-20"></div>
              <img 
                src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=800" 
                alt="Featured Customer" 
                className="relative rounded-[2rem] w-full h-[400px] lg:h-[500px] object-cover shadow-xl"
              />
              <div className="absolute -bottom-6 -right-6 md:-bottom-8 md:-right-8 bg-white p-6 rounded-[2rem] shadow-xl border border-gray-100">
            ...
            <div className="text-white space-y-8">
              ...
              <div className="pt-4">
                <Link to="/booking" tabIndex={-1}>
                  <Button size="lg" className="px-10 py-4 bg-white text-purple-900 hover:bg-gray-100 shadow-xl shadow-purple-900/20 font-bold">
